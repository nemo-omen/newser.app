...
func Search(feeds []*gofeed.Feed) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
			...
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div class=\"container stack\"><form action=\"/desk/search\" method=\"post\" class=\"search-form\"><fieldset><label for=\"searchurl\">Search</label> <input type=\"search\" name=\"searchurl\" id=\"searchurl\"> ")
			...
			if getSearchError(ctx) != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `view/pages/desk/search.templ`, Line: 24, Col: 47}
				}
